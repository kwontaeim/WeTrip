...
public class MessageController {
	...
	public Object list(HttpSession session, @RequestParam(defaultValue = "4") int memberLength) throws Exception {
	...
	public Object list(int no, HttpSession session, @RequestParam(defaultValue = "7") int length) throws Exception {
