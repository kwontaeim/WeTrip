...
public class TravelMainController {
	...
	MemberDao memberDao;
	@Autowired
	TravelMainDao travelMainDao;
	@Autowired
	TravelLocationDao travelLocationDao;
	@Autowired
	TravelMyStyleDao travelMystyleDao;
	@Autowired
	...
	ServletContext sc;
	@Autowired
	TravelMainFileDao travelMainFileDao;
	...
	public Object add(TravelMain travelMain, String schedule, HttpSession session, MultipartFile file)
			throws Exception {
		...
		List<TravelMain> list = new Gson().fromJson(schedule, new TypeToken<List<TravelMain>>() {
		}.getType());
