...
public class CmtController {
	...
	// ----------------[ test ]-------------------------------------
	/*
	 * @RequestMapping(path="cmtupdate",
	 * produces=MediaType.APPLICATION_JSON_UTF8_VALUE)
	 * 
	 * @ResponseBody public String update(Qna qna) throws Exception {
	 * HashMap<String,Object> result = new HashMap<>(); try {
	 * HashMap<String,Object> paramMap = new HashMap<>(); paramMap.put("qcno",
	 * qna.getQcno());
	 * 
	 * cmtDao.update(qna); result.put("state", "success");
	 * 
