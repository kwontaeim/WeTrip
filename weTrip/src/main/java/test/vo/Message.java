...
public class Message implements Serializable {
	...
	public String toString() {
		return "Message [messageNo=" + messageNo + ", sendMemberNo=" + sendMemberNo + ", receiveMemberNo="
				+ receiveMemberNo + ", receiveUser=" + receiveUser + ", contents=" + contents + ", sendDate=" + sendDate
				+ ", state=" + state + ", myPhoto=" + myPhoto + ", travelMainNo=" + travelMainNo + ", schduleNo="
				+ schduleNo + "]";
	}
