...
public class RegistForm implements Serializable {
	...
	public String toString() {
		return "RegistForm [no=" + no + ", memberNo=" + memberNo + ", travelMainNo=" + travelMainNo + ", locationNo="
				+ locationNo + ", styleNo=" + styleNo + ", writer=" + writer + ", title=" + title + ", styleName="
				+ styleName + ", continent=" + continent + ", nation=" + nation + ", city=" + city + ", selfIntroduce="
				+ selfIntroduce + ", startDate=" + startDate + ", endDate=" + endDate + ", myPhoto=" + myPhoto
				+ ", travelPhoto=" + travelPhoto + ", bookmarkCount=" + bookmarkCount + ", startDate1=" + startDate1
				+ ", endDate1=" + endDate1 + "]";
	}
