...
public class TravelMain implements Serializable {
	...
	public String toString() {
		return "TravelMain [travelMainNo=" + travelMainNo + ", memberNo=" + memberNo + ", title=" + title
				...
				+ ", startDate=" + startDate + ", endDate=" + endDate + ", continent=" + continent + ", nation="
				+ nation + ", city=" + city + ", lat=" + lat + ", lng=" + lng + ", styleNo=" + styleNo + ", styleName="
				+ styleName + ", travelMainPNo=" + travelMainPNo + ", startDate1=" + startDate1 + ", endDate1="
				+ endDate1 + "]";
	}
